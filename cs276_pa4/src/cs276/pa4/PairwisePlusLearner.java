...
public class PairwisePlusLearner extends Learner {
  ...
  public PairwisePlusLearner(double C, double gamma, boolean isLinearKernel){
	...
	public static void testRegressionModel() throws Exception{
		...
		PairwisePlusLearner learner = new PairwisePlusLearner(true);
...
//		}
	...
	public static void main(String[] args) throws Exception{
		//for(int i=0; i<10; i++) {
		//	System.out.println((int)(Math.random()*100)+","+(int)(Math.random()*100)+","+(int)(Math.random()*100)+","+(int)(Math.random()*100)+","+(int)(Math.random()*100)+","+((int)(Math.random()*10)<5?"-1":"+1"));
		//}
		testRegressionModel();
	}
}
